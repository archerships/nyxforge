...
*   **The Gap:** 0rbit is decentralized but not inherently anonymous. However, because it is on AO, its requests can be wrapped inside **Shielded AO** logic (ZK-SNARKs + Nullifiers) to anonymize the relationship between the bounty and the data fetcher.
