...
*   **The Log:** The AO process for a bounty becomes a "curated archive." By the year 2100, the "truth" is not fetched from the web; it is computed from 75 years of immutable evidence stored on-chain.
...
An oracle will only monitor a bounty for a century if it is profitable to do so.

*   **The Endowment:** When a Long Now bounty is issued, a percentage (e.g., 5%) of the **XMR/ZANO collateral** is diverted into a **Perpetual Yield Vault**.
...
*   **Result:** The bounty is a self-funding entity that pays for its own monitoring across generations.
...
*   **Persistence:** Existing bounty notes remain valid, but new proofs must use the upgraded, quantum-resistant standards.
