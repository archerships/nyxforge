...
*   **Issuance:** Bounties are auctioned to the highest bidder. The initial price reflects the market's estimate of the cost and difficulty of achieving the goal.
*   **Redemption:** The bounty pays out a fixed amount (e.g., $10) only upon verified achievement of the goal. It bears no interest.
*   **Secondary Market:** Bounties are freely tradeable. As progress is made toward the goal, the market price rises toward the redemption value.
...
*   **Active vs. Passive:** While some may hold bounties speculatively (free riders), the bounties naturally flow toward those who believe they can most cost-effectively achieve the outcome.
...
*   **Free Riding:** Speculators who hold bounties without helping. Horesh argues this is self-canceling: if everyone free-rides, the goal isn't met, the price drops, and active players buy the bounties at a discount.
...
*   **Perverse Incentives:** For example, in a "Crime Reduction Bounty," bondholders might lobby for draconian laws. Horesh notes that lobbying already exists; SPBs make the *motivation* for lobbying transparent and aligns it with a social goal the public has already agreed is desirable.
...
*   **Persistence:** SPBs provide stability. Even if a government changes, the bounty remains a financial obligation (on NyxForge, a smart contract log on Arweave).
...
*   **Endowments:** The "Maintenance Bounties" concept aligns with the NyxForge model of using Monero yield to fund long-term monitoring and maintenance of achieved states.

---

### Key AI Reference: "The SPB Formula"
**Value of Bounty = (Redemption Value) × (Probability of Success) / (1 + r)^t**
